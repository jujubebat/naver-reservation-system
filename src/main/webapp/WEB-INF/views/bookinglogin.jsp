...
<body class="biz  ko">
   ...
   <app>
      <toast-alert class="top_info hide booking_alert">
         ...
         <a href="./mainpage.html" class="top_info_close" data-tst_alt_close="0"> <i class="fn fn-close"
      ...
      <div class="_view_content" ui-view="content" id="container">
         <booked-confirm>
            <div class="booking_login">
               <h1 class="login_header"> <a href="./mainpage.html" class="nbooking_logo spr_bi txt_logo"> <span
                        translate="CM-NBOOKING">네이버 예약</span> </a> </h1>
               <!---->
               <div>
                  <form name="confirm_form" class="ng-pristine ng-valid" id="form1" action="./myreservation.html">
                     ...
                     <div class="login_form">
                        ...
                        <input type="text" class="login_input ng-pristine ng-untouched ng-valid ng-empty" id="resrv_id"
                           name="reservationEmail" aria-invalid="false" placeholder="example@naver.com" title="예매자이메일">
                     </div>
                     <button type="submit" form="form1" class="login_btn confirm"> <span
                           translate="CM-MY_BOOKING_CHECK">내 예약 확인</span> </button>
                  </form>
               </div>
               <!---->
               <!---->
